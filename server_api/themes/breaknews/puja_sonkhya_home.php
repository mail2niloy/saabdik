<?php
/*
*Template Name: Puja Sonkhya Home
*/
get_header();
require_once( ABSPATH . 'wp-admin/includes/template.php' );
?>
<div id="slider_contaner">
<?php echo do_shortcode('[jssor-slider alias="puja-sankhya.slider"]');?>
</div>
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
		<?php echo do_shortcode('[wcp-carousel id="2957" order="DESC" orderby="date" count="10"]  '); ?>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12 ">
			<h2 class="head_line_home"> <i>পূজা ও সংস্কৃতি  </i></h2>
		</div>
		<?php
			query_posts( array ( 'orderby'=>'rand','tag' => 'puja-2019','post_type' => 'post','category_name' => 'puja-o-sangoskriti'));
	...
	<div class="row">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
		<?php echo do_shortcode('[wcp-carousel id="2958" order="DESC" orderby="date" count="10"]  '); ?>
		</div>
	</div>
	...
	<div class="row">
		...
		<?php
			query_posts( array ( 'orderby'=>'rand','tag' => 'puja-2019','post_type' => 'post','category_name' => 'chotogolpo'));
			while ( have_posts() ) : the_post();
				$post_author_id = get_post_field( 'post_author', get_the_ID() );
				$post_id = get_the_ID();
	...
	<div class="row">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
		<div id="slider_contaner">
		<?php echo do_shortcode('[jssor-slider alias="pujo-image-gallery.slider"]');?>
		</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12 ">
			<h2 class="head_line_home"> <i>রহস্য গল্প</i></h2>
		</div>
		<?php
			query_posts( array ( 'orderby'=>'rand','tag' => 'puja-2019','post_type' => 'post','category_name' => 'rahoshyo-golpo'));
			while ( have_posts() ) : the_post();
				$post_author_id = get_post_field( 'post_author', get_the_ID() );
				$post_id = get_the_ID();
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12 ">
			<a href="<?php home_url();?>/category/rahoshyo-golpo/" class="btn btn-primary read_more" role="button">আরো রহস্য গল্প  ...</a>
		</div>
	</div>
	...
	<div class="row">
		...
		<?php
			query_posts( array ( 'orderby'=>'rand','tag' => 'puja-2019','post_type' => 'post','category_name' => 'bhraman'));
			while ( have_posts() ) : the_post();
				$post_author_id = get_post_field( 'post_author', get_the_ID() );
				$post_id = get_the_ID();
	...
	<div class="row">
		...
		<?php
			...
			query_posts( array ( 'orderby'=>'rand','tag' => 'puja-2019','post_type' => 'post','category_name' => 'kobita'));
			while ( have_posts() ) : the_post();
				$post_author_id = get_post_field( 'post_author', get_the_ID() );
