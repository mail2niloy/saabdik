...
class milliomola_popular_posts_widget extends WP_Widget {

	// Widget Setup
	function __construct() {
		parent::__construct(
			// widget ID
			'milliomola_popular_posts_widget',

			// widget name
			esc_html__( 'milliomola popular posts widget', 'breaknews' ),

			// widget options
			array( 'description' => esc_html__( 'Show Popular Posts' , 'breaknews' ) ),

			// control options
			array( 'id_base' => 'milliomola_popular_posts_widget', 'width' => 250, 'height' => 350 )
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : esc_html__( 'Popular Posts', 'breaknews' );
...
function milliomola_load_popular_posts_widget() {
	register_widget( 'milliomola_popular_posts_widget' );
}

add_action( 'widgets_init', 'milliomola_load_popular_posts_widget' );